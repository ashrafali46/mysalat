...
$(window).ready(function () {
    $("#dt").on("click change blur", function () {
        window.now = new Date($("#dt").val());
        slat();
    });
    $("#today").on("click", function () {
        window.now = new Date();
        $("#dt").val(now.getFullYear()+'/'+(now.getMonth()+1)+'/'+now.getDate())
        slat();
    });
...
function errors(error)
{
    /*switch (error.code)
    {
        case error.PERMISSION_DENIED:
            $("#lguit").html('<i class="spy"></i><h1>كيفاش نلـڤـاوك ضرك ؟&lrm;</h1><h1>شوف  <a href="https://support.google.com/chrome/answer/142065?hl=fr" target="_blank">هنا</a> ولا <a href="https://www.mozilla.org/fr/firefox/geolocation/" target="_blank">هنا</a>  ولا <a href="http://help.opera.com/Windows/12.10/fr/geolocation.html" target="_blank">هنا</a> باش تتعرف على هاذي التكنولوجيا</h1>');
            break;

        case error.POSITION_UNAVAILABLE:
            $("#lguit").html('<i class="spy"></i><h1>يـــاو مقدرناش نلڤاوك , زيد عاود نشوفو</h1><h1>شوف  <a href="https://support.google.com/chrome/answer/142065?hl=fr" target="_blank">هنا</a> ولا <a href="https://www.mozilla.org/fr/firefox/geolocation/" target="_blank">هنا</a>  ولا <a href="http://help.opera.com/Windows/12.10/fr/geolocation.html" target="_blank">هنا</a> باش تتعرف على هاذي التكنولوجيا</h1>');
            break;

        case error.TIMEOUT:
            $("#lguit").html('<i class="spy"></i><h1>العملية دامت كثر من واش لازم  زيد عاود نشوفو</h1><h1>شوف  <a href="https://support.google.com/chrome/answer/142065?hl=fr" target="_blank">هنا</a> ولا <a href="https://www.mozilla.org/fr/firefox/geolocation/" target="_blank">هنا</a>  ولا <a href="http://help.opera.com/Windows/12.10/fr/geolocation.html" target="_blank">هنا</a> باش تتعرف على هاذي التكنولوجيا</h1>');
            break;

        default:
            $("#lguit").html('<i class="spy"></i><h1>حاجة راهي ماشي نورمال زيد عاود نشوفو</h1><h1>شوف  <a href="https://support.google.com/chrome/answer/142065?hl=fr" target="_blank">هنا</a> ولا <a href="https://www.mozilla.org/fr/firefox/geolocation/" target="_blank">هنا</a>  ولا <a href="http://help.opera.com/Windows/12.10/fr/geolocation.html" target="_blank">هنا</a> باش تتعرف على هاذي التكنولوجيا</h1>');
            break;
    }*/
}
...
{
    //$("#kdb").html(salat().fajr);
    $("#sdq").html(salat().fajr); //$("#sdq").html(fajr());//ferkous method
